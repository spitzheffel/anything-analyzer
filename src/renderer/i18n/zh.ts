export const zh = {
  ...
  'report.exportMenu': '导出',
  'report.exportSpec': '导出结构化数据 (JSON)',
  'report.exportOpenApi': '导出 OpenAPI 3.1 (JSON)',
  'report.scene': '场景',
  'report.structuredData': '结构化数据',
  'report.endpoints': '端点',
  'report.authChain': '鉴权链',
  'report.specMissing': '尚未抽取结构化数据',
  'report.specFailed': '结构化数据抽取失败',
  'report.retrySpec': '重新抽取',
  'report.jumpToRequest': '跳转到请求',
  'report.citeNotFound': '在当前会话中找不到该请求',
